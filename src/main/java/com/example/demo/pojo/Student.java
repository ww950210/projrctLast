...
public class Student implements Serializable{
	...
	public String toString() {
		return "Student [stuId=" + stuId + ", stuNo=" + stuNo + ", stuName=" + stuName + ", stuPhone=" + stuPhone
				+ ", stuLimit=" + stuLimit + ", stuRemain=" + stuRemain + ", stuNote=" + stuNote + ", collegeId="
				+ collegeId + ", stuLogin=" + stuLogin + ", stuPasswd=" + stuPasswd + "]";
	}
}